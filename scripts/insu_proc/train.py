...
if __name__ == '__main__':
    ...
    ds = InsulatorObj(root=root, task_type=TASK_TYPE.DETECTION, anno_folder=anno_folder, inst_folder=inst_folder_train,
    ...
    model = UInstV1.ResUNetR34(device=device, pack=PACK.AUTO, num_cls=test_loader.num_cls,
                               img_size=img_size, )
